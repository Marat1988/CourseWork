...
namespace HostelStudent
{
    public class PortalCorporate
    {
        ...
        public static void OpenInfoStudentOnWebPortal()
        {
            ...
            {
                FileName = "http://laptop-fo5qin3i:4863/ReportServer/Pages/ReportViewer.aspx?%2fInformation%2fInfoStudents&rs:Command=Render",
        ...
        public static void OpenCardStudentOnWebPortal(int studentId)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = $"http://laptop-fo5qin3i:4863/ReportServer/Pages/ReportViewer.aspx?%2fInformation%2fCardStudent&StudentId={studentId}",
                UseShellExecute = true
            });
        }
