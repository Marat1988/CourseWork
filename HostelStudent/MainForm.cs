...
namespace HostelStudent
{
    public partial class MainForm : Form
    {
        ...
        private void ToolStripMenuItemOpenInfoWebPortal_Click(object sender, EventArgs e) => PortalCorporate.OpenInfoStudentOnWebPortal();

        private void ToolStripMenuItemOpenCardStudent_Click(object sender, EventArgs e) => PortalCorporate.OpenCardStudentOnWebPortal(studentId);
